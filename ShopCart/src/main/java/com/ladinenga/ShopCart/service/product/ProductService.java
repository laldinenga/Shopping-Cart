...
import com.ladinenga.ShopCart.exception.ProductNotFoundException;
...
import com.ladinenga.ShopCart.repository.CategoryRepository;
import com.ladinenga.ShopCart.repository.ImageRepository;
import com.ladinenga.ShopCart.repository.ProductRepository;
...
public class ProductService implements IProductService  {
    ...
    public Product addProduct(AddProductRequest request) {
        //check if the category si found in db
        //if yes, set it as new product category
        //if no, save it as a new category
        //then set as the new product category

        if (productExists(request.getName(), request.getBrand())){
            throw new AlreadyExistsException(request.getBrand()+" "+request.getName()+"Already Exist. Update the product and try again");
        }
